...
const AdminUpcomingPackages = () => {
    ...
    return (
        <section className="container-fluid py-md-4 py-2 mx-0">
            ...
            <div>
                ...
                <div className="text-center">
                    ...
                    <button
                        disabled={!packages || loading || packages.length < limit}
                        className="primary-btn"
                        onClick={() => setPage(page + 1)}
                    >
...
export default AdminUpcomingPackages